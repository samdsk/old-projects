...
function shape_posted_on() {
    printf( __('<a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate><span class="time-date">%4$s</span><span class="time-month">%8$s</span><span class="time-year">%9$s</span></time></a><span class="byline">Posted by <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'shape' ),
