...
else
{
	function wrongCaptcha(){
		echo "Codice errato riprova!";
	}
//header( 'Location: http://www.codedpixels.it/projects/project-006/contatti.php' ) ;
}
...
//header( 'Location: http://www.codedpixels.it/projects/project-006/contatti.php' ) ;
function okCatpcha(){
	echo "Il suo messaggio è stato inoltrato correttamente, La contatteremo al più presto!";
}
}
?>
    	...
    	<div id="boxcontatti">
           <div id="boxcontattiinfo">
                <div id="infoSec">
                    ...
                    <br/>                    
                    <span class="glyphicon glyphicon-globe"><p>www.enaultcolombo.com</p></span>
                    <br/>                    
        	...
        	<div id="boxcontattiform">
            	<fieldset>
                    ...
                    <form id="fields" method="POST" name="contact" action="process.php">
                        ...
                        <div class="form-group">
                        	<div class="col-sm-offset-2 col-sm-10 col-xs-10">
								<h2><?php if(function_exists('wrongCaptcha')){wrongCaptcha();}if(function_exists('okCaptcha')){okCaptcha();} ?></h2>
                       		</div>
                        </div>
                    </form>
                </fieldset>
